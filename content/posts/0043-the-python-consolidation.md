...
The consolidation of Python buildpacks reduces the number of buildpacks handling
package managers from ten to two. This will simplify the life of maintainers as
well as their users. The new buildpacks, [python-package-managers-install](https://github.com/paketo-buildpacks/python-package-managers-install/)
and [python-package-managers-run](https://github.com/paketo-buildpacks/python-package-managers-run/),
handle package managers installation and usage, respectively.

These two buildpacks are already known and used as they provide uv and Pixi.

The transition to use only the new buildpacks will be gradual, with a two-month
opt-in period, a six-month opt-out period, and eventual removal of the old
buildpacks.
